                ...
                <div className="flex gap-4 items-center">
                    ...
                    <label className="flex items-center gap-2 cursor-pointer select-none">
                        <input
                            ...
                            className="w-4 h-4 text-emerald-600 rounded show-answers-checkbox"
                        />
                        <span className="text-sm font-medium text-emerald-700">Answers</span>
                    </label>
                    <button
                        onClick={() => setWorksheetId(prev => prev + 1)}
                        className="bg-emerald-600 text-white px-3 py-1.5 rounded text-sm hover:bg-emerald-700 flex items-center gap-1 new-worksheet-btn"
                    >
